...
function shownotes() {
    ...
    for (let i = 0; i < notesObj.length; i += 3) {
        ...
        <pre class="card-text" style="overflow-wrap:break-word;white-space:pre-wrap;overflow-x:auto;">${notesObj[i + 1]}</pre>
    ...
    <div class="card-text" style="overflow:hidden;">Please click the following button to try your first note. Just add title and text you want and press the button Add note to save your first note or else click the following button to start with you first note.</div>
